            ...
            <section className="hero hero__contact">
                ...
                <div className="container hero__container">
                    ...
                    <div className="hero__actions">
                        <Link className='ui__btn' href="/produits/omnia">Découvrir OMNIA</Link>
                        <Link className='ui__btn' href="/produits/transformation-digitale/presentation">Démarrer votre transformation digitale</Link>
                        <Link className='ui__btn' href="/produits/use-cases">Voir nos Use Cases</Link>
                    </div>
                </div>                
            </section>
        </main>
