            ...
            <section className="hero">
                ...
                <div className="container hero__container">
                    ...
                    <div className="hero__actions">
                        <Link className='ui__btn--gradient' href="/produits/use-cases?content=omniscan">Découvrir les use cases</Link>
                        <Link className='ui__btn--inline' href="/contact">Demander une démo</Link>
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    ...
                    <ul className='omniscan__users--cards'>
                        ...
                        <li className='card'>
                            ...
                            <Link className='ui__btn--gradient' href="/produits/contact">Demander une démo</Link>
                        </li>
                    </ul>
                </div>
            </section>
